...
Found a bug? Do you have an idea that could make Noahh better? You can submit an issue on our GitHub repository. Please do check if your specific problem already has an open issue. Also, **please only open issues that are related to Noahh itself**, issues that are related to installed mods will have lower priority, we'll try and tell you where to contact the developer of the mod, but then we'll close the issue.

## Submitting a Pull Request

Before starting work on a Pull Request, please read our code style guidelines, which you can find [here](https://docs.noahh-sdk.org/source/styling).
...
If you want to help reverse engineer the game and submit bindings / class members, go to our [bindings repository](https://github.com/noahh-sdk/bindings).
