...
${LangFileString} NOAHH_TEXT_GD_OLD "$\r$\n$\r$\nVaše verze Geometry Dash je moc stará pro tuto verzi Noahh!"
${LangFileString} NOAHH_TEXT_MOD_LOADER_ALREADY_INSTALLED "V této cestě jsou již nainstalovány jiné mody!$\r$\nNoahh bude nainstalován místo nich. (the dll trademark)"

; uninstaller

${LangFileString} NOAHH_UNTEXT_NOAHH_MISSING "V této cestě se nenachází Noahh!"
