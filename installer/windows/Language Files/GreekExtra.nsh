...
${LangFileString} NOAHH_TEXT_GD_MISSING "$\r$\n$\r$\nΑυτό το path δεν έχει το Geometry Dash εγκατεστημένο!"
${LangFileString} NOAHH_TEXT_GD_OLD "$\r$\n$\r$\nΗ έκδοση του Geometry Dash σας είναι πολύ παλιά για αυτή την έκδοση του Noahh!"
${LangFileString} NOAHH_TEXT_MOD_LOADER_ALREADY_INSTALLED "Αυτή η διαδρομή έχει ήδη εγκατεστημένα άλλα mods!$\r$\nΘα αντικατασταθούν από το Noahh. (the dll trademark)"

; uninstaller

${LangFileString} NOAHH_UNTEXT_NOAHH_MISSING "Αυτό το path δεν έχει το Noahh εγκατεστημένο!"
