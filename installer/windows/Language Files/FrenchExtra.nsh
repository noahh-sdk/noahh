...
${LangFileString} NOAHH_TEXT_GD_OLD "$\r$\n$\r$\nVotre version de Geometry Dash est trop ancienne pour cette version de Noahh !"
${LangFileString} NOAHH_TEXT_MOD_LOADER_ALREADY_INSTALLED "Ce chemin a d'autres mods installés !$\r$\nIls seront écrasés par Noahh. (the dll trademark)"

; uninstaller

${LangFileString} NOAHH_UNTEXT_NOAHH_MISSING "Noahh n'est pas installé sur ce chemin !"
