...
${LangFileString} NOAHH_TEXT_GD_OLD "$\r$\n$\r$\nYour version of Geometry Dash is too old for this version of Noahh!"
${LangFileString} NOAHH_TEXT_MOD_LOADER_ALREADY_INSTALLED "This path has other mods installed!$\r$\nThey will be overwritten by Noahh. (the dll trademark)"

; uninstaller

${LangFileString} NOAHH_UNTEXT_NOAHH_MISSING "This path does not have Noahh installed!"
