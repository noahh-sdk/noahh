...
#include <Noahh/modify/Addresses.hpp>
#include <Noahh/modify/Types.hpp>
using namespace noahh;
using namespace noahh::cast;
using cocos2d::CCDestructor;
using namespace noahh::core::meta; // Default convention
using namespace noahh::core::meta::x86; // Windows x86 conventions, Function
using namespace noahh::modifier; // types
)CAC";
