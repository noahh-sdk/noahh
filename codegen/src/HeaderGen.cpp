...
public:
	...
	NOAHH_MONOSTATE_CONSTRUCTOR_GD({class_name}, {first_base})
)GEN";

	char const* monostate_constructor_cutoff = R"GEN(
	NOAHH_MONOSTATE_CONSTRUCTOR_CUTOFF({class_name}, {first_base})
)GEN";
    ...
    NOAHH_PAD({hardcode});)GEN";
    char const* unimplemented_definition = R"GEN(
    NOAHH_UNIMPLEMENTED_PAD)GEN";
