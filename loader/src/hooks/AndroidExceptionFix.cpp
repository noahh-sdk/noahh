...
#endif
    auto vtable = reinterpret_cast<noahh::cast::VtableType*>(*(intptr_t*)adjustedPtr);
    auto complete = static_cast<noahh::cast::CompleteVtableType*>(vtable);
...
$execute {
    ...
    noahh::cast::DummyClass dummyClass;
    auto vtable = reinterpret_cast<noahh::cast::VtableType*>(*(intptr_t*)&dummyClass);
    auto complete = static_cast<noahh::cast::CompleteVtableType*>(vtable);
    auto typeinfo = complete->m_typeinfo;
