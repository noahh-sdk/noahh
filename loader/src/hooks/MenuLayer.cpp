	...
	bool init() {
		...
		if (failed.size()) {
            auto layer = FLAlertLayer::create(
				"Notice",
				"Some mods failed to load; see <cy>Noahh</c> for details",
				"OK"
			);
			layer->m_scene = this;
