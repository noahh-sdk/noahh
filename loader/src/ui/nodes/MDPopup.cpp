...
public:
    noahh::Function<void(bool)> onClick = nullptr;
};
...
bool MDPopup::init(
    ...
    ZStringView btn2Text, noahh::Function<void(bool)> onClick
) {
    if (!Popup::init(
        400.f,
...
MDPopup* MDPopup::create(
    ...
    ZStringView btn2, noahh::Function<void(bool)> onClick
) {
...
const noahh::Function<void(bool)>& MDPopup::getOnClick() {
    return m_impl->onClick;
}

void MDPopup::setOnClick(noahh::Function<void(bool)> onClick) {
    m_impl->onClick = std::move(onClick);
}
