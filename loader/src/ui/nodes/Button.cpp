...
public:
    ...
    noahh::Ref<cocos2d::CCActionInterval> m_clickAction = nullptr;
    noahh::Ref<cocos2d::CCActionInterval> m_releaseAction = nullptr;

    noahh::Ref<cocos2d::CCActionInterval> m_activeClickAction = nullptr;
    noahh::Ref<cocos2d::CCActionInterval> m_activeReleaseAction = nullptr;

    cocos2d::CCNode* m_displayNode = nullptr;

    noahh::Ref<cocos2d::CCNodeRGBA> m_defaults = nullptr;
};
