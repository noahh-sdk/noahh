...
public:
    ...
    void charIteration(noahh::FunctionRef<CCLabelBMFont*(CCLabelBMFont* line, char c, float top)> overflowHandling);
...
void SimpleTextArea::Impl::charIteration(noahh::FunctionRef<CCLabelBMFont*(CCLabelBMFont* line, char c, float top)> overflowHandling) {
    float top = 0;
    m_lines.clear();
