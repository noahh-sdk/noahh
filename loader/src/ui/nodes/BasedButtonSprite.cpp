...
const char* noahh::baseEnumToString(CircleBaseSize value) {
    switch (value) {
...
const char* noahh::baseEnumToString(CircleBaseColor value) {
    switch (value) {
...
const char* noahh::baseEnumToString(CrossBaseSize value) {
    switch (value) {
...
const char* noahh::baseEnumToString(CrossBaseColor value) {
    switch (value) {
...
const char* noahh::baseEnumToString(AccountBaseSize value) {
    switch (value) {
...
const char* noahh::baseEnumToString(AccountBaseColor value) {
    switch (value) {
...
const char* noahh::baseEnumToString(IconSelectBaseSize value) {
    switch (value) {
...
const char* noahh::baseEnumToString(IconSelectBaseColor value) {
    switch (value) {
...
const char* noahh::baseEnumToString(EditorBaseSize value) {
    switch (value) {
...
const char* noahh::baseEnumToString(EditorBaseColor value) {
    switch (value) {
...
const char* noahh::baseEnumToString(TabBaseSize value) {
    switch (value) {
...
const char* noahh::baseEnumToString(TabBaseColor value) {
    switch (value) {
...
const char* noahh::baseEnumToString(LeaderboardBaseSize value) {
    switch (value) {
...
const char* noahh::baseEnumToString(LeaderboardBaseColor value) {
    switch (value) {
...
const char* noahh::baseEnumToString(CategoryBaseSize value) {
    switch (value) {
...
const char* noahh::baseEnumToString(CategoryBaseColor value) {
    switch (value) {
...
const char* noahh::baseEnumToString(BaseType value) {
    switch (value) {
