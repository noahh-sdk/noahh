#include <Noahh/binding/ProfilePage.hpp>
#include <Noahh/binding/LevelTools.hpp>
#include <Noahh/binding/LevelInfoLayer.hpp>
#include <Noahh/binding/CCContentLayer.hpp>
#include <Noahh/binding/GJSearchObject.hpp>
#include <Noahh/binding/LevelBrowserLayer.hpp>
#include <Noahh/loader/Mod.hpp>
#include <Noahh/loader/Loader.hpp>
#include <Noahh/ui/MDTextArea.hpp>
#include <Noahh/ui/BreakLine.hpp>
...
void MDTextArea::onNoahhMod(CCObject* sender) {
            ...
            case MD_TEXTTYPE::MD_TEXT_NORMAL:
                {
                    if (!s_lastLink.empty()) {
                                ...
                                utils::string::startsWith(s_lastLink, "user:")
                                    ...
                                    : utils::string::startsWith(s_lastLink, "level:")
                                        ...
                                        : utils::string::startsWith(s_lastLink, "mod:")
                                            ? menu_selector(MDTextArea::onNoahhMod)
                        ...
                        if (spr && spr->getUserObject("noahh.texture-loader/fallback") == nullptr) {
