...
#include <Noahh/binding/SliderThumb.hpp>
#include <Noahh/ui/ColorPickPopup.hpp>
...
public:
    ...
    noahh::Function<void(cocos2d::ccColor4B const&)> m_callback;
...
void ColorPickPopup::setCallback(noahh::Function<void(cocos2d::ccColor4B const&)> callback) {
