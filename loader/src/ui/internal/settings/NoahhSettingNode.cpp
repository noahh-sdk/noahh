...
#include "NoahhSettingNode.hpp"
#include <general/TextRenderer.hpp>
#include <random>
#include <utils/WackyNoahhMacros.hpp>

USE_NOAHH_NAMESPACE();

#define NOAHH_GENERATE_SETTING_CREATE(_sett_, _height_)                \
...
bool BoolSettingNode::init(BoolSetting* setting) {
	if (!NoahhSettingNode<BoolSetting>::init(setting))
		return false;
...
bool IntSettingNode::init(IntSetting* setting) {
	if (!NoahhSettingNode<IntSetting>::init(setting))
		return false;
...
bool FloatSettingNode::init(FloatSetting* setting) {
	if (!NoahhSettingNode<FloatSetting>::init(setting))
		return false;
...
bool StringSettingNode::init(StringSetting* setting) {
	if (!NoahhSettingNode<StringSetting>::init(setting))
		return false;
...
bool ColorSettingNode::init(ColorSetting* setting) {
	if (!NoahhSettingNode<ColorSetting>::init(setting))
		return false;
...
bool ColorAlphaSettingNode::init(ColorAlphaSetting* setting) {
	if (!NoahhSettingNode<ColorAlphaSetting>::init(setting))
		return false;
...
bool PathSettingNode::init(PathSetting* setting) {
	if (!NoahhSettingNode<PathSetting>::init(setting))
		return false;
...
bool StringSelectSettingNode::init(StringSelectSetting* setting) {
	if (!NoahhSettingNode<StringSelectSetting>::init(setting))
		return false;
...
NOAHH_GENERATE_SETTING_CREATE(BoolSetting, 30.f);
NOAHH_GENERATE_SETTING_CREATE(IntSetting, 30.f);
NOAHH_GENERATE_SETTING_CREATE(FloatSetting, 30.f);
NOAHH_GENERATE_SETTING_CREATE(StringSetting, 30.f);
NOAHH_GENERATE_SETTING_CREATE(ColorSetting, 30.f);
NOAHH_GENERATE_SETTING_CREATE(ColorAlphaSetting, 30.f);
NOAHH_GENERATE_SETTING_CREATE(PathSetting, 30.f);
NOAHH_GENERATE_SETTING_CREATE(StringSelectSetting, 30.f);*/