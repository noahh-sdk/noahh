...
namespace noahh {
	...
	class NoahhSettingNode : public SettingNode {
	protected:
		...
		bool init(SettingClass* setting) {
			...
			if (m_setting->getDescription().size()) {
				...
				m_descButton = CCMenuItemSpriteExtra::create(
					descBtnSpr, this, menu_selector(NoahhSettingNode::onDescription)
				);
		...
		NoahhSettingNode(float width, float height) : SettingNode(width, height) {}
	};

	class BoolSettingNode : public NoahhSettingNode<BoolSetting> {
	protected:
		...
		BoolSettingNode(float width, float height) : NoahhSettingNode<BoolSetting>(width, height) {}

	public:
		static BoolSettingNode* create(BoolSetting* setting, float width);
	};

	class IntSettingNode : public NoahhSettingNode<IntSetting>, public TextInputDelegate {
	protected:
		...
		IntSettingNode(float width, float height) : NoahhSettingNode<IntSetting>(width, height) {}

	public:
		static IntSettingNode* create(IntSetting* setting, float width);
	};

	class FloatSettingNode : public NoahhSettingNode<FloatSetting>, public TextInputDelegate {
	protected:
		MenuInputNode* m_valueInput;
		Slider* m_slider = nullptr;
		...
		FloatSettingNode(float width, float height) : NoahhSettingNode<FloatSetting>(width, height) {}

	public:
		static FloatSettingNode* create(FloatSetting* setting, float width);
	};

	class StringSettingNode : public NoahhSettingNode<StringSetting>, public TextInputDelegate {
	protected:
		...
		StringSettingNode(float width, float height) : NoahhSettingNode<StringSetting>(width, height) {}
		
	public:
		static StringSettingNode* create(StringSetting* setting, float width);
	};

	class ColorSettingNode : public NoahhSettingNode<ColorSetting> {
	protected:
		...
		ColorSettingNode(float width, float height) : NoahhSettingNode<ColorSetting>(width, height) {}
	...
	class ColorAlphaSettingNode : public NoahhSettingNode<ColorAlphaSetting> {
	protected:
		ColorChannelSprite* m_colorSprite;
		...
		ColorAlphaSettingNode(float width, float height) : NoahhSettingNode<ColorAlphaSetting>(width, height) {}
	...
	class PathSettingNode : public NoahhSettingNode<PathSetting>, public TextInputDelegate {
	protected:
		MenuInputNode* m_input;
		...
		PathSettingNode(float width, float height) : NoahhSettingNode<PathSetting>(width, height) {}

	public:
		static PathSettingNode* create(PathSetting* setting, float width);
	};

	class StringSelectSettingNode : public NoahhSettingNode<StringSelectSetting> {
	protected:
		...
		StringSelectSettingNode(float width, float height) : NoahhSettingNode<StringSelectSetting>(width, height) {}
