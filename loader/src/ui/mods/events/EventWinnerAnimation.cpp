...
#include <Noahh/binding/CCLightFlash.hpp>
#include <Noahh/binding/GameToolbox.hpp>
#include <Noahh/binding/FMODAudioEngine.hpp>
#include <Noahh/binding/CCCircleWave.hpp>
