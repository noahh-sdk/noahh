...
bool BaseSettingsPopup::init(bool forceDisableTheme, bool spacingForTabs) {
    if (!NoahhPopup::init(440, 280, NoahhPopupStyle::Default, forceDisableTheme))
        return false;
    ...
    auto searchClearSpr = NoahhSquareSprite::createWithSpriteFrameName("GJ_deleteIcon_001.png", nullptr, m_forceDisableTheme);
    ...
    m_mainLayer->addChildAtPosition(
        createNoahhListBorders(m_listSize, m_forceDisableTheme),
    ...
    auto restartBtnSpr = createNoahhButton("Restart Now", true, NoahhButtonSprite::Default, m_forceDisableTheme);
    ...
    m_applyBtnSpr = createNoahhButton("Apply", true, NoahhButtonSprite::Default, m_forceDisableTheme);
    ...
    auto resetBtnSpr = createNoahhButton("Reset All", true, NoahhButtonSprite::Default, m_forceDisableTheme);
...
void BaseSettingsPopup::updateState(SettingNode* invoker) {
    ...
    auto clearSpr = static_cast<NoahhSquareSprite*>(m_searchClearBtn->getNormalImage());
    ...
    if (this->hasUncommitted()) {
        createQuickPopup(
            ...
            [this](FLAlertLayer*, bool btn2) {
                if (btn2) {
                    NoahhPopup::onClose(nullptr);
                }
            }
        );
        return;
    }
    NoahhPopup::onClose(sender);
}
