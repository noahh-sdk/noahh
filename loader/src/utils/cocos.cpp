...
#include <Noahh/utils/operators.hpp>
#include <Noahh/utils/WackyNoahhMacros.hpp>

USE_NOAHH_NAMESPACE();

CCRect noahh::cocos::calculateNodeCoverage(std::vector<CCNode*> const& nodes) {
    CCRect coverage;
...
void noahh::cocos::limitNodeSize(
    cocos2d::CCNode* spr,
...
bool noahh::cocos::nodeIsVisible(cocos2d::CCNode* node) {
...
bool noahh::cocos::fileExistsInSearchPaths(const char* filename) {
