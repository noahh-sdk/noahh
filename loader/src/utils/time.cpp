...
std::string noahh::utils::timePointAsString(std::chrono::system_clock::time_point const& tp) {
...
std::string noahh::utils::timeToAgoString(std::chrono::system_clock::time_point tp, bool abbreviated) {
...
std::string noahh::utils::timeToAgoString(asp::SystemTime tp, bool abbreviated) {
