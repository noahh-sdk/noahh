...
Result<float> noahh::utils::_detail::floatFromString(std::string_view str) {
    return parseFloat<float>(str);
}

Result<double> noahh::utils::_detail::doubleFromString(std::string_view str) {
    return parseFloat<double>(str);
}

Result<long double> noahh::utils::_detail::longDoubleFromString(std::string_view str) {
...
Result<uint64_t> noahh::utils::_detail::uint64FromString(std::string_view str, int base) {
    return parseInt<uint64_t>(str, base);
}

Result<int64_t> noahh::utils::_detail::int64FromString(std::string_view str, int base) {
