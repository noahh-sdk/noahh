...
void noahh::utils::game::exit(bool saveData) {
    // TODO: mat
    #if 0
...
void noahh::utils::game::restart(bool saveData) {
    // TODO: mat
    ...
    // launch updater
    auto const updaterPath = workingDir / "NoahhUpdater.exe";
...
void noahh::utils::game::launchLoaderUninstaller(bool deleteSaveData) {
    ...
    if (!exists((workingDir / "NoahhUninstaller.exe"))) {
    ...
    // launch uninstaller
    auto const uninstallerPath = workingDir / "NoahhUninstaller.exe";
