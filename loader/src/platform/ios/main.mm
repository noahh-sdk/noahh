...
// bool loadNoahh() {
//     auto orig = noahh::hook::replaceObjcMethod("AppController", "application:didFinishLaunchingWithOptions:", (void*)applicationDidFinishLaunchingHook);
//     if (!orig)
//         return false;
...
__attribute__((constructor)) void _entry() {
    ...
    if (Loader::get()->isPatchless()) {
        NOAHH_MOD_STATIC_PATCH(0x2699d0, "\x03\x1e\x91\x52");
    }
    else {
        auto const address = reinterpret_cast<void*>(noahh::base::get() + 0x2699d0);
