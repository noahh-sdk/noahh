...
#include <Noahh/utils/Keyboard.hpp>
...
extern "C" JNIEXPORT void JNICALL Java_com_noahh_launcher_utils_NoahhUtils_internalKeyEvent(
...
extern "C" JNIEXPORT void JNICALL Java_com_noahh_launcher_utils_NoahhUtils_internalScrollEvent(
...
extern "C" JNIEXPORT void JNICALL Java_com_noahh_launcher_utils_NoahhUtils_internalTouchEvent(
...
extern "C" JNIEXPORT void JNICALL Java_com_noahh_launcher_utils_NoahhUtils_internalJoystickEvent(
...
extern "C"
JNIEXPORT void JNICALL Java_com_noahh_launcher_utils_NoahhUtils_inputDeviceAdded(JNIEnv*, jobject, jint deviceId, jint eventSource) {
    noahh::AndroidInputDeviceEvent().send(deviceId, noahh::AndroidInputDeviceStatus::Added);
}

extern "C"
JNIEXPORT void JNICALL Java_com_noahh_launcher_utils_NoahhUtils_inputDeviceChanged(JNIEnv*, jobject, jint deviceId, jint eventSource) {
    noahh::AndroidInputDeviceEvent().send(deviceId, noahh::AndroidInputDeviceStatus::Changed);
}

extern "C"
JNIEXPORT void JNICALL Java_com_noahh_launcher_utils_NoahhUtils_inputDeviceRemoved(JNIEnv*, jobject, jint deviceId, jint eventSource) {
    noahh::AndroidInputDeviceEvent().send(deviceId, noahh::AndroidInputDeviceStatus::Removed);
}
