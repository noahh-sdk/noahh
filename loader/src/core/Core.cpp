...
#ifndef NOAHH_IS_WINDOWS

#if defined(NOAHH_IS_MACOS)
    #include "MacOS.hpp"
#elif defined(NOAHH_IS_IOS)
    // #include "iOS.hpp"
#endif

namespace noahh::core::impl {
	namespace {
		auto& originalBytes() {
...
bool noahh::core::hook::initialize() {
	return noahh::core::impl::TargetPlatform::initialize();
}
