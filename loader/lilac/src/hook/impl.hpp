#ifndef NOAHH_CORE_HOOK_IMPL_HPP
#define NOAHH_CORE_HOOK_IMPL_HPP
...
namespace lilac::hook {
    ...
    public:
        ...
        static hook::Handle NOAHH_CALL add_hook(const void* address, const void* detour);
        static bool NOAHH_CALL remove_hook(hook::Handle handle);
    };
}

#endif /* NOAHH_CORE_HOOK_IMPL_HPP */
