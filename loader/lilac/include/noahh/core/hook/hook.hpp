#ifndef NOAHH_CORE_HOOK_HPP
#define NOAHH_CORE_HOOK_HPP
...
namespace lilac::hook {
     ...
     */
    Handle NOAHH_CALL add(const void* address, const void* detour);
     ...
     */
    bool NOAHH_CALL remove(Handle handle);
     ...
     * false if not
     */
    bool NOAHH_CALL write_memory(void* address, void* data, size_t size);
     ...
     * false if not
     */
    bool NOAHH_CALL read_memory(void* address, void* receive, size_t size);
}

#endif /* NOAHH_CORE_HOOK_HPP */