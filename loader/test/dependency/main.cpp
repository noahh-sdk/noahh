...
struct AfterMenuLayer : Modify<AfterMenuLayer, MenuLayer> {
    static void onModify(auto& self) {
        if (self.setHookPriorityAfterPost("MenuLayer::init", "noahh.test")) {
...
struct BeforeMenuLayer : Modify<BeforeMenuLayer, MenuLayer> {
    static void onModify(auto& self) {
        if (self.setHookPriorityBeforePost("MenuLayer::init", "noahh.test")) {
...
$on_mod(Loaded) {
    ...
    MyDispatchEvent("noahh.test/test-garage-open").listen(+[](GJGarageLayer* gl) {
