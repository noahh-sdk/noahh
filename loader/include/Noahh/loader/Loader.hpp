...
namespace noahh {
    ...
    static constexpr std::string_view NOAHH_DIRECTORY          = "noahh";
    static constexpr std::string_view NOAHH_MOD_DIRECTORY      = "mods";
    static constexpr std::string_view NOAHH_LOG_DIRECTORY      = "log";
    static constexpr std::string_view NOAHH_RESOURCE_DIRECTORY = "resources";
    static constexpr std::string_view NOAHH_TEMP_DIRECTORY     = "temp";
    static constexpr std::string_view NOAHH_MOD_EXTENSION      = ".noahh";
    ...
    protected:
         ...
         * Any mod targeting a noahh version 
         ...
         * the user's noahh is out-of-date, 
    ...
    public:
         ...
         */
        ghc::filesystem::path getNoahhDirectory() const;
        /**
         ...
         * valid .noahh file in the mods directory will 
        ...
        /**
         * Get Noahh's internal representation. Use with 
         * caution!
