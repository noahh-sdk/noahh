...
namespace noahh {
    ...
    class NOAHH_DLL SettingV3 : public std::enable_shared_from_this<SettingV3> {
    private:
        class NoahhImpl;
        std::shared_ptr<NoahhImpl> m_impl;
    ...
    protected:
         ...
         * using Noahh's JSON checking utilities, you can use the other
         * overload of `init`
         */
         ...
         * @param key The setting's key as defined in `mod.json`
         * @param modID The ID of the mod this settings is being parsed for
         * @note If you are using Noahh's JSON checking utilities
         ...
         * aren't using Noahh's JSON checking utilities, use the other overload
         * of this function
         ...
         * @param key The setting's key as defined in `mod.json`
         * @param modID The ID of the mod this settings is being parsed for
         * @param json The JSON value. If you are using Noahh's JSON checking
    ...
    using SettingGeneratorV3 = noahh::Function<Result<std::shared_ptr<SettingV3>>(
        std::string key,
        std::string modID,
        matjson::Value const& json
    )>;

    using SettingGeneratorV3Ref = noahh::FunctionRef<Result<std::shared_ptr<SettingV3>>(
        std::string key,
        std::string modID,
        matjson::Value const& json
    )>;
    ...
    protected:
        ...
        void parseDefaultValue(JsonExpectedValue& json) {
            ...
            if (root.isObject() && root.has(NOAHH_PLATFORM_SHORT_IDENTIFIER_NOARCH)) {
                root.needs(NOAHH_PLATFORM_SHORT_IDENTIFIER_NOARCH).into(m_impl->defaultValue);
            }
            else {
    ...
    class NOAHH_DLL TitleSettingV3 final : public SettingV3 {
    private:
        class Impl;
        std::shared_ptr<Impl> m_impl;
    ...
    class NOAHH_DLL BoolSettingV3 final : public SettingBaseValueV3<bool> {
    private:
        class Impl;
        std::shared_ptr<Impl> m_impl;
    ...
    class NOAHH_DLL IntSettingV3 final : public SettingBaseValueV3<int64_t> {
    private:
        class Impl;
        std::shared_ptr<Impl> m_impl;
    ...
    class NOAHH_DLL FloatSettingV3 final : public SettingBaseValueV3<double> {
    private:
        class Impl;
        std::shared_ptr<Impl> m_impl;
    ...
    class NOAHH_DLL StringSettingV3 final : public SettingBaseValueV3<std::string, std::string_view> {
    private:
        class Impl;
        std::shared_ptr<Impl> m_impl;
    ...
    class NOAHH_DLL FileSettingV3 final : public SettingBaseValueV3<std::filesystem::path, std::filesystem::path const&> {
    private:
        class Impl;
        std::shared_ptr<Impl> m_impl;
    ...
    class NOAHH_DLL Color3BSettingV3 final : public SettingBaseValueV3<cocos2d::ccColor3B> {
    private:
        class Impl;
        std::shared_ptr<Impl> m_impl;
    ...
    class NOAHH_DLL Color4BSettingV3 final : public SettingBaseValueV3<cocos2d::ccColor4B> {
    private:
        class Impl;
        std::shared_ptr<Impl> m_impl;
    ...
    class NOAHH_DLL KeybindSettingV3 final : public SettingV3 {
    private:
        class Impl;
        std::shared_ptr<Impl> m_impl;
    ...
    class NOAHH_DLL SettingNodeV3 : public cocos2d::CCNode {
    private:
        class Impl;
        std::shared_ptr<Impl> m_impl;
    ...
    public:
        ...
        NOAHH_DLL SettingChangedEventV3(Mod* mod, std::string settingKey);
    };
    ...
    public:
        ...
        // filter params modID, settingKey
        using GlobalEvent::GlobalEvent;
        NOAHH_DLL KeybindSettingPressedEventV3(Mod* mod, std::string settingKey);
    };
    ...
    public:
        ...
        // filter params modID, settingKey
        using GlobalEvent::GlobalEvent;
        NOAHH_DLL SettingNodeSizeChangeEventV3(Mod* mod, std::string settingKey);
    };
    ...
    public:
        ...
        // filter params modID, settingKey
        using GlobalEvent::GlobalEvent;
        NOAHH_DLL SettingNodeValueChangeEventV3(Mod* mod, std::string settingKey);
    };
    ...
    ListenerHandle* listenForSettingChanges(std::string settingKey, Callback&& callback, Mod* mod = getMod()) {
        ...
        if constexpr (std::is_same_v<Ret, void>) {
            return SettingChangedEventV3(mod, std::move(settingKey)).listen([callback = std::move(callback)](std::shared_ptr<SettingV3> setting) {
                if (auto ty = noahh::cast::typeinfo_pointer_cast<Ty>(setting)) {
