...
namespace noahh {                  
    ...
    struct NOAHH_DLL ModInfo {
         ...
         * the mod zip
         */
        std::string m_binaryName = NOAHH_WINDOWS("mod.dll")
                                   NOAHH_MACOS("mod.dylib")
                                   NOAHH_IOS("mod.dylib")
                                   NOAHH_ANDROID("mod.so");
        /**
         ...
         * https://github.com/noahh-sdk/api/blob/main/include/nodes/MDTextArea.hpp) 
         * for more info
         */
        ...
        /**
         * Create ModInfo from a .noahh package
         */
        static Result<ModInfo> createFromNoahhFile(ghc::filesystem::path const& path);
        /**
    ...
    protected:
         ...
         */
        noahh_load m_implicitLoadFunc = nullptr;
        /**
         * Pointer to the Mod's load function
         */
        noahh_load m_loadFunc = nullptr;
        /**
         * Pointer to the Mod's unload function
         */
        noahh_unload m_unloadFunc = nullptr;
        /**
         * Pointer to the Mod's enable function
         */
        noahh_enable m_enableFunc = nullptr;
        /**
         * Pointer to the Mod's enable function
         */
        noahh_disable m_disableFunc = nullptr;
        noahh_load_data m_loadDataFunc = nullptr;
        noahh_save_data m_saveDataFunc = nullptr;
        noahh_setting_updated m_settingUpdatedFunc = nullptr;
        /**
    ...
    public:
        ...
        /**
         * Log to noahh's integrated console / 
         * the platform debug console.
         * @returns Reference to log stream. Make sure 
         * to end your logging with noahh::endl.
         */
        Log log();
         ...
         * then delete the mod's .noahh file.
         * @returns Successful result on success, 
         * errorful result with info on error
         */
        Result<> uninstall();
