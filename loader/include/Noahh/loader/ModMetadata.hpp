...
namespace noahh {
    ...
    class NOAHH_DLL ModMetadataLinks final {
        class Impl;
     ...
     * from mod.json
     */
    class NOAHH_DLL ModMetadata final {
        class Impl;
        std::unique_ptr<Impl> m_impl;
    ...
    public:
        ...
        class NOAHH_DLL Dependency final {
            class Impl;
            std::unique_ptr<Impl> m_impl;
        ...
        class NOAHH_DLL Incompatibility final {
            class Impl;
            std::unique_ptr<Impl> m_impl;
        ...
        class NOAHH_DLL IssuesInfo final {
            class Impl;
            std::unique_ptr<Impl> m_impl;
         ...
         * <Noahh/ui/MDTextArea.hpp>) for more info
         */
        ...
        */
        ...
        /**
         * Gets the target Noahh version for the current platform.
        */
        [[nodiscard]] VersionInfo getNoahhVersion() const;
        ...
        */
        ...
        /**
         * Checks if mod can be installed on the current Noahh version.
         * Returns Ok() if it can, Err explaining why not otherwise.
        */
        Result<> checkNoahhVersion() const;
        /**
         * Checks if mod can be installed on the current GD & Noahh version.
         * Returns Ok() if it can, Err explaining why not otherwise.
        */
        ...
        void setNoahhVersion(VersionInfo value);
        ModMetadataLinks& getLinksMut();
#endif

        /**
         * Create `ModMetadata` from a `.noahh` package. Note that this
         * function may fail if the JSON data is wrong; make sure to check
         * `hasErrors()` afterwards on the `ModMetadata`!
         */
        static ModMetadata createFromNoahhFile(std::filesystem::path const& path);
        /**
...
template <>
struct matjson::Serialize<noahh::ModMetadata> {
    static Value toJson(noahh::ModMetadata const& value) {
