 ...
 */
#define NOAHH_AS_STATIC_FUNCTION(FunctionName_)                                                   \
    ...
    struct AsStaticFunction_##FunctionName_ {                                                     \
        ...
        struct Impl<Return (*)(Params...)> {                                                      \
            static Return NOAHH_CDECL_CALL function(Params... params) {                           \
                return Class2::FunctionName_(params...);                                          \
            }                                                                                     \
        };                                                                                        \
        template <class Return, class Class, class... Params>                                     \
        struct Impl<Return (Class::*)(Params...)> {                                               \
            static Return NOAHH_CDECL_CALL function(Class* self, Params... params) {              \
        ...
        struct Impl<Return (Class::*)(Params...) const> {                                         \
            static Return NOAHH_CDECL_CALL function(Class const* self, Params... params) {        \
                auto self2 = addresser::rthunkAdjust(                                             \
                    Resolve<Params...>::func(&Class2::FunctionName_), self                        \
                );                                                                                \
                return self2->Class2::FunctionName_(params...);                                   \
    ...
    NOAHH_AS_STATIC_FUNCTION(constructor)
    NOAHH_AS_STATIC_FUNCTION(destructor)


#define NOAHH_CONCEPT_FUNCTION_CHECK(FunctionName_)                                              \
