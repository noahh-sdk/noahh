...
namespace noahh::modifier {
    ...
    private:
        ...
        std::vector<noahh::Function<void(void*)>> m_destructorFunctions;
    ...
    public:
        ...
        void* setField(size_t index, size_t size, noahh::Function<void(void*)> destructor) {
    ...
    NOAHH_DLL size_t getFieldIndexForClass(char const* name);
