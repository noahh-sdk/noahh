#ifndef NOAHH_CORE_META_MEMBERCALL_HPP
#define NOAHH_CORE_META_MEMBERCALL_HPP
...
namespace noahh::core::meta::x86 {
    ...
    private:
        ...
        class Impl {
            static_assert(
                always_false<Class>,
                "Please report a bug to the Noahh developers! This should never be reached.\n"
...
#endif /* NOAHH_CORE_META_MEMBERCALL_HPP */