#ifndef NOAHH_CORE_META_FUNCTION_HPP
#define NOAHH_CORE_META_FUNCTION_HPP
...
namespace noahh::core::meta {
    /* The Noahh Function class wraps functions with unconventional
...
#endif /* NOAHH_CORE_META_FUNCTION_HPP */