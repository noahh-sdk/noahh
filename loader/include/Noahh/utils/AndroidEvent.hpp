...
namespace noahh {
    namespace utils {
        ...
        noahh::Result<int> getLauncherVersion();
    }

    class NOAHH_DLL AndroidKeyInput final {
    protected:
        int m_keycode;
        int m_modifiers;
        int m_repeatCount;
    ...
    class NOAHH_DLL AndroidScrollInput final {
    protected:
        float m_scrollX;
        float m_scrollY;
    ...
    class NOAHH_DLL AndroidTouchInput final {
    public:
        struct Data final {
            int id;
            float x;
    ...
    class NOAHH_DLL AndroidJoystickInput final {
    public:
        struct Data final {
            float leftX;
            float leftY;
