...
namespace noahh {
     ...
     *
     * To help with this, Noahh provides the `ColorProvider` class, which is
     ...
     */
    class NOAHH_DLL ColorProvider final {
    private:
        class Impl;
...
inline cocos2d::ccColor4B operator""_cc4b_gd(const char* str, size_t) {
    return noahh::ColorProvider::get()->color(str);
}
inline cocos2d::ccColor3B operator""_cc3b_gd(const char* str, size_t) {
    return noahh::ColorProvider::get()->color3b(str);
}
inline cocos2d::ccColor4B operator""_cc4b(const char* str, size_t) {
    return noahh::ColorProvider::get()->color(noahh::Mod::get()->expandSpriteName(str));
}
inline cocos2d::ccColor3B operator""_cc3b(const char* str, size_t) {
    return noahh::ColorProvider::get()->color3b(noahh::Mod::get()->expandSpriteName(str));
}
