...
struct fmt::formatter<noahh::utils::BasicStringBuffer<C, N>> : formatter<string_view> {
    auto format(noahh::utils::BasicStringBuffer<C, N> const& result, fmt::format_context& ctx) const noexcept {
