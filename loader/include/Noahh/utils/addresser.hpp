...
namespace noahh::addresser {
	...
	class NOAHH_DLL Addresser final {
		template <char C>
		...
		static intptr_t addressOfVirtual(R(T::*func)(Ps...), 
			...
			using noahh::cast::reference_cast;
		...
		static intptr_t addressOfNonVirtual(R(T::*func)(Ps...)) {
			return noahh::cast::reference_cast<intptr_t>(func);
		}
		...
		template<typename T>
		inline intptr_t getVirtual(T func) {
			Interface::get()->logInfo("Get virtual function address from " + utils::intToHex(noahh::cast::reference_cast<intptr_t>(func)), Severity::Debug);
		...
		template<typename T>
		inline intptr_t getNonVirtual(T func) {
			Interface::get()->logInfo("Get non-virtual function address from " + utils::intToHex(noahh::cast::reference_cast<intptr_t>(func)), Severity::Debug);
