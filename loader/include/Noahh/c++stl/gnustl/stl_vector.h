  ...
  */
  template<typename _Tp, typename _Alloc = allocator<_Tp> >
    ...
    public:
      ...
      typedef noahh::stl::__normal_iterator<pointer, vector> iterator;
      typedef noahh::stl::__normal_iterator<const_pointer, vector>
      const_iterator;
    ...
    private:
      ...
      void
      _M_move_assign(vector&& __x, noahh::stl::true_type) noexcept
      {
	...
	if (_Alloc_traits::_S_propagate_on_move_assign())
      ...
      void
      _M_move_assign(vector&& __x, noahh::stl::false_type)
      {
	if (__x._M_get_Tp_allocator() == this->_M_get_Tp_allocator())
	  _M_move_assign(std::move(__x), noahh::stl::true_type());
	else
	  {
