...
_GLIBCXX_BEGIN_NAMESPACE_VERSION
  ...
  template<typename _Alloc, typename _Tp>
	...
	static constexpr noahh::stl::true_type
	_S_chk(typename _Alloc2::template rebind<_Tp2>::other*);

      template<typename, typename>
	static constexpr noahh::stl::false_type
	_S_chk(...);
...
_GLIBCXX_ALLOC_TR_NESTED_TYPE(propagate_on_container_copy_assignment,
       ...
       * otherwise @c noahh::stl::false_type
      */
...
#undef _GLIBCXX_ALLOC_TR_NESTED_TYPE
	...
	struct __allocate_helper
	{
	  template<typename _Alloc3,
	    ...
	    static noahh::stl::true_type __test(int);

	  template<typename>
	    static noahh::stl::false_type __test(...);
  ...
  template<typename _Alloc>
    inline void
    __do_alloc_on_copy(_Alloc& __one, const _Alloc& __two, noahh::stl::true_type)
    { __one = __two; }

  template<typename _Alloc>
    inline void
    __do_alloc_on_copy(_Alloc&, const _Alloc&, noahh::stl::false_type)
    { }
  ...
  template<typename _Alloc>
    inline void __do_alloc_on_move(_Alloc& __one, _Alloc& __two, noahh::stl::true_type)
    { __one = std::move(__two); }

  template<typename _Alloc>
    inline void __do_alloc_on_move(_Alloc&, _Alloc&, noahh::stl::false_type)
    { }
  ...
  template<typename _Alloc>
    inline void __do_alloc_on_swap(_Alloc& __one, _Alloc& __two, noahh::stl::true_type)
    {
      swap(__one, __two);
    }

  template<typename _Alloc>
    inline void __do_alloc_on_swap(_Alloc&, _Alloc&, noahh::stl::false_type)
    { }
  ...
  template<typename _Alloc>
	...
	static noahh::stl::true_type
	_M_select(int);

      template<typename _Up>
	static noahh::stl::false_type
	_M_select(...);
