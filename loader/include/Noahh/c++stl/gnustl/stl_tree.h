...
_GLIBCXX_BEGIN_NAMESPACE_CONTAINER
  ...
  template<typename _Key, typename _Val, typename _KeyOfValue,
	...
	if (__x._M_root() != nullptr)
      ...
      {
	if (__x._M_root() != 0)
	  _M_move_data(__x, noahh::stl::true_type());
      }
    ...
    private:
      ...
      void
      _M_move_data(_Rb_tree&, noahh::stl::true_type);

      // Move elements from container with possibly non-equal allocator,
      // which might result in a copy not a move.
      void
      _M_move_data(_Rb_tree&, noahh::stl::false_type);
    };
  ...
  template<typename _Key, typename _Val, typename _KeyOfValue,
    ...
    void
    _Rb_tree<_Key, _Val, _KeyOfValue, _Compare, _Alloc>::
    _M_move_data(_Rb_tree& __x, noahh::stl::true_type)
    {
      _M_root() = __x._M_root();
  ...
  template<typename _Key, typename _Val, typename _KeyOfValue,
    ...
    void
    _Rb_tree<_Key, _Val, _KeyOfValue, _Compare, _Alloc>::
    _M_move_data(_Rb_tree& __x, noahh::stl::false_type)
    {
