...
_GLIBCXX_BEGIN_NAMESPACE_VERSION
  ...
  template<typename _Key, typename _Value, typename _Alloc,
	...
	_M_assign(const _Hashtable&, const _NodeGenerator&);
      ...
      void
      _M_move_assign(_Hashtable&&, noahh::stl::true_type);

      void
      _M_move_assign(_Hashtable&&, noahh::stl::false_type);
	...
	pair<iterator, bool>
	_M_emplace(noahh::stl::true_type, _Args&&... __args);

      template<typename... _Args>
	iterator
	_M_emplace(noahh::stl::false_type __uk, _Args&&... __args)
	{ return _M_emplace(cend(), __uk, std::forward<_Args>(__args)...); }

      // Emplace with hint, useless when keys are unique.
      template<typename... _Args>
	iterator
	_M_emplace(const_iterator, noahh::stl::true_type __uk, _Args&&... __args)
	{ return _M_emplace(__uk, std::forward<_Args>(__args)...).first; }

      template<typename... _Args>
	iterator
	_M_emplace(const_iterator, noahh::stl::false_type, _Args&&... __args);

      template<typename _Arg, typename _NodeGenerator>
	pair<iterator, bool>
	_M_insert(_Arg&&, const _NodeGenerator&, noahh::stl::true_type);

      template<typename _Arg, typename _NodeGenerator>
	iterator
	_M_insert(_Arg&& __arg, const _NodeGenerator& __node_gen,
		  noahh::stl::false_type __uk)
	{
		  ...
		  noahh::stl::true_type __uk)
	{
      ...
      template<typename _Arg, typename _NodeGenerator>
	iterator
	_M_insert(const_iterator, _Arg&&, const _NodeGenerator&, noahh::stl::false_type);

      size_type
      _M_erase(noahh::stl::true_type, const key_type&);

      size_type
      _M_erase(noahh::stl::false_type, const key_type&);
    ...
    private:
      ...
      void _M_rehash_aux(size_type __n, noahh::stl::true_type);

      // Helper rehash method used when keys can be non-unique.
      void _M_rehash_aux(size_type __n, noahh::stl::false_type);
  ...
  template<typename _Key, typename _Value,
    ...
    _Hashtable<_Key, _Value, _Alloc, _ExtractKey, _Equal,
	       _H1, _H2, _Hash, _RehashPolicy, _Traits>::
    _M_move_assign(_Hashtable&& __ht, noahh::stl::true_type)
    {
      this->_M_deallocate_nodes(_M_begin());
      _M_deallocate_buckets();
  ...
  template<typename _Key, typename _Value,
    ...
    _Hashtable<_Key, _Value, _Alloc, _ExtractKey, _Equal,
	       _H1, _H2, _Hash, _RehashPolicy, _Traits>::
    _M_move_assign(_Hashtable&& __ht, noahh::stl::false_type)
    {
      if (__ht._M_node_allocator() == this->_M_node_allocator())
	_M_move_assign(std::move(__ht), noahh::stl::true_type());
      else
	{
  ...
  template<typename _Key, typename _Value,
    ...
    template<typename... _Args>
      ...
      _Hashtable<_Key, _Value, _Alloc, _ExtractKey, _Equal,
		 _H1, _H2, _Hash, _RehashPolicy, _Traits>::
      _M_emplace(const_iterator __hint, noahh::stl::false_type, _Args&&... __args)
      {
  ...
  template<typename _Key, typename _Value,
    ...
    template<typename _Arg, typename _NodeGenerator>
      ...
      _Hashtable<_Key, _Value, _Alloc, _ExtractKey, _Equal,
		 _H1, _H2, _Hash, _RehashPolicy, _Traits>::
      _M_insert(_Arg&& __v, const _NodeGenerator& __node_gen, noahh::stl::true_type)
      {
  ...
  template<typename _Key, typename _Value,
    ...
    _Hashtable<_Key, _Value, _Alloc, _ExtractKey, _Equal,
	       _H1, _H2, _Hash, _RehashPolicy, _Traits>::
    _M_erase(noahh::stl::true_type, const key_type& __k)
    {
      __hash_code __code = this->_M_hash_code(__k);
  ...
  template<typename _Key, typename _Value,
    ...
    _Hashtable<_Key, _Value, _Alloc, _ExtractKey, _Equal,
	       _H1, _H2, _Hash, _RehashPolicy, _Traits>::
    _M_erase(noahh::stl::false_type, const key_type& __k)
    {
      __hash_code __code = this->_M_hash_code(__k);
      std::size_t __bkt = _M_bucket_index(__k, __code);
  ...
  template<typename _Key, typename _Value,
    ...
    _Hashtable<_Key, _Value, _Alloc, _ExtractKey, _Equal,
	       _H1, _H2, _Hash, _RehashPolicy, _Traits>::
    _M_rehash_aux(size_type __n, noahh::stl::true_type)
    {
  ...
  template<typename _Key, typename _Value,
    ...
    _Hashtable<_Key, _Value, _Alloc, _ExtractKey, _Equal,
	       _H1, _H2, _Hash, _RehashPolicy, _Traits>::
    _M_rehash_aux(size_type __n, noahh::stl::false_type)
    {
      __bucket_type* __new_buckets = _M_allocate_buckets(__n);
