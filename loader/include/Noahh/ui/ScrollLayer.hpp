...
#include <Noahh/binding/CCScrollLayerExt.hpp>
#include <memory>
...
namespace noahh {
     ...
     */
    class NOAHH_DLL GenericContentLayer : public CCContentLayer {
    public:
    ...
    class NOAHH_DLL ScrollLayer : public CCScrollLayerExt {
    protected:
