...
class NOAHH_DLL LayoutOptions : public cocos2d::CCObject {
public:
 ...
 */
class NOAHH_DLL AxisLayoutOptions final : public LayoutOptions {
protected:
    class Impl;
 ...
 * menu->updateLayout();
 */
class NOAHH_DLL AxisLayout : public Layout {
protected:
    class Impl;
 ...
 */
class NOAHH_DLL RowLayout final : public AxisLayout {
protected:
    RowLayout();
 ...
 */
class NOAHH_DLL ColumnLayout final : public AxisLayout {
protected:
    ColumnLayout();
 ...
 */
class NOAHH_DLL AnchorLayoutOptions final : public LayoutOptions {
protected:
 ...
 */
class NOAHH_DLL AnchorLayout : public Layout {
public:
 ...
 */
class NOAHH_DLL CopySizeLayout final : public AnchorLayout {
protected:
