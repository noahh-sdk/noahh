...
class NOAHH_DLL SimpleAxisLayoutOptions : public LayoutOptions {
protected:
    class Impl;
...
class NOAHH_DLL SimpleAxisLayout : public Layout {
protected:
    class Impl;
...
class NOAHH_DLL SimpleRowLayout final : public SimpleAxisLayout {
protected:
    SimpleRowLayout();
...
class NOAHH_DLL SimpleColumnLayout final : public SimpleAxisLayout {
protected:
    SimpleColumnLayout();
...
class NOAHH_DLL AxisGap final : public cocos2d::CCNode {
protected:
    class Impl;
