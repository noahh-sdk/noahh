...
namespace noahh {
    class NOAHH_DLL Button : public cocos2d::CCNodeRGBA, public cocos2d::CCTouchDelegate {
    public:
        using ButtonCallback = noahh::Function<void(Button* sender)>;
         ...
         * @param activateCallback The callback for when the button is activated
         */
        static Button* createWithSprite(noahh::ZStringView fileName, ButtonCallback activateCallback = nullptr);
         ...
         * @param activateCallback The callback for when the button is activated
         */
        static Button* createWithSpriteFrameName(noahh::ZStringView frameName, ButtonCallback activateCallback = nullptr);
         ...
         * @param activateCallback The callback for when the button is activated
         */
        static Button* createWithLabel(noahh::ZStringView text, noahh::ZStringView font, ButtonCallback activateCallback = nullptr);
    ...
    protected:
        ...
        bool initWithSprite(noahh::ZStringView fileName, ButtonCallback activateCallback);
        bool initWithSpriteFrameName(noahh::ZStringView frameName, ButtonCallback activateCallback);
        bool initWithLabel(noahh::ZStringView text, noahh::ZStringView font, ButtonCallback activateCallback);
     ...
     */
    class NOAHH_DLL SharedButtonHandler {
    public:
