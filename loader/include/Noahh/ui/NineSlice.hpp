...
namespace noahh {
    class NOAHH_DLL NineSlice : public cocos2d::CCNodeRGBA {
    public:
        ...
        static NineSlice* create(noahh::ZStringView file, cocos2d::CCRect const& rect = {}, Insets const& insets = {});
        static NineSlice* createWithSpriteFrameName(noahh::ZStringView spriteFrameName, Insets const& insets = {});
    ...
    protected:
        ...
        bool initWithFile(noahh::ZStringView file, cocos2d::CCRect const& rect, Insets const& insets);
        bool initWithSpriteFrameName(noahh::ZStringView spriteFrameName, Insets const& insets);
