...
namespace noahh {
     ...
     */
    NOAHH_DLL cocos2d::CCSprite* createLayerBG();
     ...
     */
    NOAHH_DLL void addListBorders(
        cocos2d::CCNode* to,
        cocos2d::CCPoint const& center,
        cocos2d::CCSize const& size
    );

    class NOAHH_DLL ListBorders : public cocos2d::CCNode {
        class Impl;
     ...
     */
    NOAHH_DLL CCMenuItemSpriteExtra* addBackButton(
        cocos2d::CCNode* to,
