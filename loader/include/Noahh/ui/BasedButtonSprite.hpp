...
namespace noahh {
    ...
    NOAHH_DLL const char* baseEnumToString(CircleBaseSize);
    ...
    enum class CircleBaseColor {
        ...
        Blue = 3,
        Cyan = 4,
        DarkPurple = 5, // Noahh-added color, used in Noahh UIs
        DarkAqua = 6,   // Noahh-added color, used in Noahh UIs
    };
    NOAHH_DLL const char* baseEnumToString(CircleBaseColor);

    enum class CrossBaseSize {
        Small = 0,  // the size of the icon kit / create button
        Huge = 1,   // the size of the play button
    };
    NOAHH_DLL const char* baseEnumToString(CrossBaseSize);

    enum class CrossBaseColor {
        Green = 0,
    };
    NOAHH_DLL const char* baseEnumToString(CrossBaseColor);

    enum class AccountBaseSize {
        Normal = 0,
    };
    NOAHH_DLL const char* baseEnumToString(AccountBaseSize);
    ...
    NOAHH_DLL const char* baseEnumToString(AccountBaseColor);

    enum class IconSelectBaseSize {
        Normal = 0,
    };
    NOAHH_DLL const char* baseEnumToString(IconSelectBaseSize);

    enum class IconSelectBaseColor {
        Unselected = 0,
        Selected = 1,
    };
    NOAHH_DLL const char* baseEnumToString(IconSelectBaseColor);

    enum class EditorBaseSize {
        Normal = 0,
    };
    NOAHH_DLL const char* baseEnumToString(EditorBaseSize);
    ...
    NOAHH_DLL const char* baseEnumToString(EditorBaseColor);

    enum class TabBaseSize {
        Normal = 0,
    };
    NOAHH_DLL const char* baseEnumToString(TabBaseSize);
    ...
    NOAHH_DLL const char* baseEnumToString(TabBaseColor);

    enum class LeaderboardBaseSize {
        Normal = 0,
    };
    NOAHH_DLL const char* baseEnumToString(LeaderboardBaseSize);

    enum class LeaderboardBaseColor {
        Blue = 0,
    };
    NOAHH_DLL const char* baseEnumToString(LeaderboardBaseColor);

    enum class CategoryBaseSize {
        Big = 0,
    };
    NOAHH_DLL const char* baseEnumToString(CategoryBaseSize);

    enum class CategoryBaseColor {
        Green = 0,
    };
    NOAHH_DLL const char* baseEnumToString(CategoryBaseColor);
    ...
    NOAHH_DLL const char* baseEnumToString(BaseType);
     ...
     */
    class NOAHH_DLL BasedButtonSprite : public cocos2d::CCSprite {
        class Impl;
     ...
     */
    class NOAHH_DLL CircleButtonSprite final : public BasedButtonSprite {
    public:
     ...
     * menu
     */
    class NOAHH_DLL CrossButtonSprite final : public BasedButtonSprite {
    public:
     ...
     * menu
     */
    class NOAHH_DLL AccountButtonSprite final : public BasedButtonSprite {
    public:
     ...
     * menu
     */
    class NOAHH_DLL IconSelectButtonSprite final : public BasedButtonSprite {
    public:
     ...
     * menu
     */
    class NOAHH_DLL LeaderboardButtonSprite final : public BasedButtonSprite {
    public:
     ...
     */
    class NOAHH_DLL EditorButtonSprite final : public BasedButtonSprite {
    public:
     ...
     */
    class NOAHH_DLL TabButtonSprite final : public BasedButtonSprite {
    public:
     ...
     * CreatorLayer
     */
    class NOAHH_DLL CategoryButtonSprite final : public BasedButtonSprite {
    public:
