...
namespace noahh::noahh_internal {
    ...
    inline void dummyModifyFn(::noahh::Modify<D, B> const&);

    template <class T>
    concept IsModifyClass = requires(std::remove_pointer_t<T> const& a) { ::noahh::noahh_internal::dummyModifyFn(a); };
    ...
    inline constexpr void typeinfoCastChecks() {
        ...
        static_assert(!noahh_internal::IsModifyClass<After>,
